...
# ADD CPP /nologo /MT /W3 /GX /O2 /Oy- /I "..\_" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "ssu_EXPORTS" /D WINVER=0x400 /D _WIN32_IE=0 /D _WIN32_WINNT=0 /YX /FD /GA /QI0f /c
...
# ADD CPP /nologo /MTd /W3 /Gm /GX /ZI /Od /I "..\_" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "ssu_EXPORTS" /FR /YX /FD /GZ /c
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib wininet.lib /nologo /dll /debug /machine:I386 /out:"D:\ssp_src_set\ssp\ghost\R_POST_and_KOMAINU\ghost\master\saori\ssu.dll" /pdbtype:sept
